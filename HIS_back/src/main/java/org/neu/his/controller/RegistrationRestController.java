...
import org.neu.his.dao.RegistrationMapper;
import org.neu.his.entity.Registration;
import org.neu.his.entity.RegistrationExample;
...
public class RegistrationRestController{
    ...
    public CommonResponse getList(
        ...
        if (sort != null && order != null)
            switch (order.toLowerCase()) {
                case "asc":
                    example.setOrderByClause(Registration.Column.valueOf(sort).asc());
                    break;
                case "desc":
                    example.setOrderByClause(Registration.Column.valueOf(sort).desc());
                    break;
                default:
    ...
    @Transactional
    public Registration insertOne(@RequestBody Registration record) {
    ...
    @Transactional
    public List<Registration> insertBatch(@RequestBody List<Registration> records) {
    ...
    @Transactional
    public int updateOne(@RequestBody Registration record) {
    ...
    @Transactional
    public long updateBatch(@RequestBody List<Registration> records) {
        int count = 0;
        for (Registration record : records) {
