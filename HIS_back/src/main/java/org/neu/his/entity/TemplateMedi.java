...
public class TemplateMedi implements Serializable {
    ...
    public TemplateMedi withDoctor_id(Integer doctor_id) {
    ...
    public TemplateMedi withCreate_time(Date create_time) {
    ...
    public TemplateMedi withIs_deleted(Boolean is_deleted) {
