...
public class CategoryConstantExample {
    ...
    public CategoryConstantExample() {
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        public Criteria andLogicalDeleted(boolean deleted) {
            return deleted ? andIs_deletedEqualTo(CategoryConstant.DELETED) : andIs_deletedNotEqualTo(CategoryConstant.DELETED);
        }
    }
